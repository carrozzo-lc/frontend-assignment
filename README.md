...
For the server you can start the the app with `yarn workspace @frontend-assignment/server start`, and for the client you can start the the app with `yarn workspace @frontend-assignment/client start`.
